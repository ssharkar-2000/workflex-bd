...
export const envSchema = z.object({
  ...
  WALLET_DEPOSIT_BKASH: z.string().optional(),
  WALLET_DEPOSIT_NAGAD: z.string().optional(),
  WALLET_DEPOSIT_BANK: z.string().optional(),
  /** The name on those accounts, so the sender can check it before sending. */
  WALLET_DEPOSIT_NAME: z.string().optional(),
  /**
