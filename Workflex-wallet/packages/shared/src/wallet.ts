...
export const walletSummarySchema = z.object({
  ...
  /**
   * The part of `balance` that was earned — paid in by another account on
   * the platform — and so can be withdrawn. Money the person added themselves
   * is for paying people and stays in the wallet.
   */
