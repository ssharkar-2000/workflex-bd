...
const MESSAGE_KEYS: Record<string, TranslationKey> = {
  ...
  [ApiErrorCode.APPLICATION_WITHDRAWN]: 'error.APPLICATION_WITHDRAWN',

  [ApiErrorCode.INSUFFICIENT_BALANCE]: 'error.INSUFFICIENT_BALANCE',
  [ApiErrorCode.NOT_WITHDRAWABLE]: 'error.NOT_WITHDRAWABLE',
  [ApiErrorCode.NOT_HIRED]: 'error.NOT_HIRED',
  [ApiErrorCode.PAYMENT_GATEWAY_UNAVAILABLE]: 'error.PAYMENT_GATEWAY_UNAVAILABLE',
  [ApiErrorCode.ALREADY_PROCESSED]: 'error.ALREADY_PROCESSED',
