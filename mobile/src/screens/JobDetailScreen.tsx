...
import { Avatar, BackButton, Button, Card, Chip, DetailRow, ErrorState, Loading, StatusPill } from '../components';
  ...
  return (
    ...
    >
      ...
      <View style={s.actions}>
        ...
        />
        <Button label={t('jobDetail.edit')} variant="outline" tint={categoryPalette[3]} disabled={busy} onPress={startEdit} />
        <Button
